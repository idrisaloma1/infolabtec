        ...
        {selected && (
          <form onSubmit={handleSave} className="rounded-xl border border-white/10 bg-navy-800/40 p-6 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Field label="Video Demo URL" value={form.video_url} onChange={(v) => setForm((f) => ({ ...f, video_url: v }))} />
            </div>

            <div>
              <label className="block text-xs uppercase tracking-wider text-white/50 mb-1.5">Screenshot</label>
