  ...
  return (
    <section className="pt-32 pb-24">
      <div className="mx-auto max-w-4xl px-5 lg:px-8">
        <p className="text-cyan-400 text-sm font-semibold tracking-[0.2em] uppercase text-center">About Us</p>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div>
            <h2 className="font-display font-semibold text-xl text-cyan-400">Who We Are</h2>
          ...
          <div>
            <h2 className="font-display font-semibold text-xl text-cyan-400">Our Mission</h2>
            <p className="mt-3 text-white/70 leading-relaxed text-sm">
          ...
          <div>
            <h2 className="font-display font-semibold text-xl text-cyan-400">Our Vision</h2>
            <p className="mt-3 text-white/70 leading-relaxed text-sm">
